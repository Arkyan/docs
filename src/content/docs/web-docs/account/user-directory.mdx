...
Click a user to open their [public profile](/guides/account/public-profile/).
...
Handles are unique and chosen in [Profile Settings](/guides/account/profile-settings/).
...
If you find policy violations, open their profile and use **Report user** to file a [support ticket](/guides/account/support-tickets/). Do not harass users in DMs or on Discord.
...
- [Public Profile](/guides/account/public-profile/)
