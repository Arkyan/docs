...
Click a user to open their [public profile](/web-docs/account/public-profile/).
...
Handles are unique and chosen in [Profile Settings](/web-docs/account/profile-settings/).
...
If you find policy violations, open their profile and use **Report user** to file a [support ticket](/web-docs/account/support-tickets/). Do not harass users in DMs or on Discord.
...
- [Public Profile](/web-docs/account/public-profile/)
