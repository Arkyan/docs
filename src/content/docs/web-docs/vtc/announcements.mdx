...
Assign these through [VTC Roles & Permissions](/web-docs/vtc/roles-permissions/):
...
- [VTC Roles & Permissions](/web-docs/vtc/roles-permissions/): assign announcement permissions to roles
- [VTC Member Management](/web-docs/vtc/member-management/): actions that trigger member events
- [VTC Recruitment](/web-docs/vtc/recruitment/): application events and recruitment toggles
- [VTC Discord Verification](/web-docs/vtc/discord-verification/): separate from announcements; links your server for profile display
- [General Settings](/web-docs/vtc/general-settings/): VTC identity and recruitment settings
