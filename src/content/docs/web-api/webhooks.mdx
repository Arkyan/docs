...
Developer Console webhooks are different. They are account-level HTTP endpoints for your integration code. See [VTC Announcements](/web-docs/vtc/announcements/) for the Discord-focused feature.
