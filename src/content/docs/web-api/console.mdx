...
**Quotas** shows your current API tier (`free`, `basic`, `premium`, `unlimited`), effective limits, and any anti-abuse state. Tier upgrades are assigned by staff; contact [support](/guides/account/support-tickets/) for commercial needs.
