...
If your API key is exposed publicly (e.g. committed to a repository), rotate it immediately - see [Leaked API Keys & Secrets](/web-api/leaked-secrets/).
...
For Node.js integrations, you can use the official client instead of hand-written `fetch` calls. See [TypeScript SDK](/web-api/sdk/).
...
- [Swagger UI](/web-api/public-api/doc): browse the full schema interactively, right here in the docs.

## Related guides

- [Developer Platform Overview](/web-api/overview/)
- [OAuth Apps](/web-api/oauth-apps/) (user sign-in, not required for public read endpoints)
- [Webhooks](/web-api/webhooks/) (event push notifications)
- [Leaked API Keys & Secrets](/web-api/leaked-secrets/) (remediation if a key is exposed)
