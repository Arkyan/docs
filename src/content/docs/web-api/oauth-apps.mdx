...
1. Enable [Developer Mode](/web-api/overview/#before-you-start) and open the [Developer Console](https://trucklinemp.com/developer).
...
- [Developer Console](/web-api/console/)
