...
- English: `https://docs.trucklinemp.com/guides/vtc-programs/verified/`
- Polish: `https://docs.trucklinemp.com/pl/guides/vtc-programs/verified/`
- German: `https://docs.trucklinemp.com/de/guides/vtc-programs/verified/`
- French: `https://docs.trucklinemp.com/fr/guides/vtc-programs/verified/`
...
1. Find the English source file (e.g., `src/content/docs/guides/vtc-programs/verified.mdx`)
2. Create the matching file in the target locale folder (e.g., `src/content/docs/pl/guides/vtc-programs/verified.mdx`)
...
```
http://localhost:4321/pl/guides/vtc-programs/verified/
```
...
- Example: `/guides/vtc-programs/verified/` → `/pl/guides/vtc-programs/verified/`
...
✅ `/pl/guides/vtc-programs/verified/`
...
Translators and contributors are credited on the [Contributors](/guides/contribute/contributors/) page. Thank you for helping make TrucklineMP accessible to everyone!
